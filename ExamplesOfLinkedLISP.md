...
;; of a CSV File. Note the form for calling object methods are like
...
(print ("Tasks"
	("Parser" ;; simple LISP parser + URIs and prefixes
	 "Execution Environment" ;; Executing and calling functions
	 "Built in functions" ;; 
	 )
	)
)
